...
C Carbon Variables
       ...
       COMMON /CARBON_NEEDS/
     &              pH, pCO2, Atmosp, apCO2Sat,FluxCO2, FluxO2,!makai add ","
C     &              FluxO2TH,FluxN2O,FluxN2OTH,FluxAR!makai
     &              FluxO2TH,FluxN2O,FluxN2OTH,FluxAR,apN2Osat!makai 20240621
...
C Adding arrays for new gas fluxes
      ...
      _RL apN2OSat(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)!makai 20240621
