...
C makai
      INTEGER iO2TH !makai
      INTEGER iN2O!makai
      INTEGER iN2OTH!makai  
      INTEGER iAr!makai
      PARAMETER (iO2TH = eChl+1)!makai
      PARAMETER (iN2O = iO2TH+1)!makai
      PARAMETER (iN2OTH = iN2O+1)!makai
      PARAMETER (iAr = iN2OTH+1)!makai
C makai
      PARAMETER (nDarwin=iAr)
