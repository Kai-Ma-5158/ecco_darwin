...
C makai 20240621
C pN2O forcing parameters for exf

      _RL pN2OStartTime

      COMMON/darwin_forcing_pN2O_c/
     &    pN2Omask
      COMMON/darwin_forcing_pN2O_i/
     &    pN2Ostartdate1, pN2Ostartdate2
      COMMON/darwin_forcing_pN2O_r/
     &    pN2OStartTime,
     &    pN2Operiod, pN2ORepCycle, pN2Oconst,
     &    pN2O_exfremo_intercept, pN2O_exfremo_slope,
     &    darwin_inscal_pN2O
      CHARACTER*1 pN2Omask
      INTEGER pN2Ostartdate1
      INTEGER pN2Ostartdate2
      _RL pN2Operiod
      _RL pN2ORepCycle
      _RL pN2Oconst
      _RL pN2O_exfremo_intercept
      _RL pN2O_exfremo_slope
      _RL darwin_inscal_pN2O

#ifdef USE_EXF_INTERPOLATION
      COMMON/darwin_interp_pN2O_i/
     &    pN2O_nlon, pN2O_nlat, pN2O_interpMethod
      COMMON/darwin_interp_pN2O_r/
     &    pN2O_lon0, pN2O_lat0, pN2O_lon_inc, pN2O_lat_inc
      INTEGER pN2O_interpMethod, pN2O_nlon, pN2O_nlat
      _RL  pN2O_lon0
      _RL  pN2O_lat0
      _RL  pN2O_lon_inc
      _RL  pN2O_lat_inc(MAX_LAT_INC)
#endif
